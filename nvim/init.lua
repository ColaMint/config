...
require("lazy").setup({
    {
        ...
        config = function()
            ...
            vim.cmd("let $BAT_THEME = 'Monokai Extended'")
        end,
    },
    -- {
    -- 	"habamax/vim-godot",
    -- 	config = function()
    -- 		vim.g.godot_executable = "/Applications/Godot_mono.app"
    ...
    -- },
    {
        ...
        config = function()
            ...
            lspconfig.omnisharp.setup({
                cmd = { "dotnet", "/Users/liming/bin/omnisharp-osx-arm64-net6.0/OmniSharp.dll" },
                settings = {
                    FormattingOptions = {
    ...
    { "scrooloose/nerdcommenter" },
    {
        ...
        config = function()
            ...
            vim.api.nvim_set_keymap("n", "<C-l>", "<cmd>Telescope live_grep<cr>", {
                noremap = true,
    ...
    { "psliwka/vim-smoothie" },
    {
        ...
        config = function()
            vim.api.nvim_set_keymap("n", "<C-d>", "<cmd>DogeGenerate<cr>", {
                noremap = true,
                desc = "DogeGenerate",
            })
        end,
